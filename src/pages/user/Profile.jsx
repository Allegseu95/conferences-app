              ...
              <div className='card-body'>
                <div className='d-flex m-2'>
                  ...
                  <div className='input-group input-group-sm row row-cols-1 row-cols-md-2'>
                    <b className='input-group-text p-1 fs-5 col-md-2'>Nombre</b>
                    <input
                ...
                <div className='d-flex m-2'>
                  ...
                  <div className='input-group input-group-sm row row-cols-1 row-cols-md-2'>
                    <b className='input-group-text p-1 col-md-2 fs-5'>Apellido</b>
                    <input
                ...
                <div className='d-flex m-2'>
                  ...
                  <div className='input-group input-group-sm row row-cols-1 row-cols-md-2'>
                    <b className='input-group-text p-2 fs-5 col-md-4'>Empresa/Institucion</b>
                    <input
