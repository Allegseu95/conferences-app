...
export const Regitsers = ({ data, itemsPerPage }) => {
  ...
  const updateregister= async(status, registerid)=>{
    ...
    const datosupdate = Object.freeze({
      status:sendstatus, registerId:registerid
    })
      ...
      return (
        <tr key={index}>
          ...
          {/* <button onClick={getregisterapi()} className='btn btn-success p-1'>
            ...
            <button onClick={()=> updateregister(status, _id)} className='btn btn-success p-1 left'>
            ...
            <button
              ...
              className={voucherURL === null? 'btn btn-secondary p-1 left':'btn btn-primary p-1 left'}
              data-toggle='modal'
